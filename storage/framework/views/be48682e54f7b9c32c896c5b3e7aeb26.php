...
<table class="table table-striped">
  ...
  <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      ...
      <td>
        <div>
        <form action="<?php echo e(route('editor.validation-article')); ?>"  method="post" enctype="multipart/form-data" >
          <?php echo csrf_field(); ?>
          <input type="hidden " value="<?php echo e($article->id); ?>" name="id">
          <input type="hidden " value="<?php echo e(auth::user()->email); ?>" name="editoId">
