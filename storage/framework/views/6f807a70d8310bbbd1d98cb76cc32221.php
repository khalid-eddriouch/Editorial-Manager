...
<?php $__env->startSection('article_traitement'); ?>
<div>
    ...
    <tr>
      ...
      <td>
        ...
        <form action="<?php echo e(route('editor.send-to-reviewers')); ?>"  method="get" enctype="multipart/form-data" >         
          ...
          <input type="hidden" value="<?php echo e($article->reviewer1Id); ?>" name="rev1Id">
...
<?php echo $__env->make('dashboard.editor.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\khalid1\Desktop\pfe-demo - Copy (2)\resources\views/dashboard/editor/article/traitement_article.blade.php ENDPATH**/ ?>