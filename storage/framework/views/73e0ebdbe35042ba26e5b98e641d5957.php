<?php $__env->startSection('show_accept_article_home'); ?>
<style>
  .home-image{
...
<table id="article-section" class="table table-striped">
  <form action="<?php echo e(route('search_article')); ?>" method="get">
    <thead>
    <tr>
      <th scope="col">
 ...
 <div class="container-articles">
  <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="article-box">
      <div class="img-article"><img src="<?php echo e(asset('/storage/images/articles/'.$article->pic)); ?>" style="height: 300px; with: 200px;" alt=""></div>
      <div class="article-text">
        <a href="" class="article-title"><?php echo e($article->title); ?></a>
        <p>by <?php echo e($article->author_first_name); ?> <?php echo e($article->author_last_name); ?></p>
        <a href="">Read More</a>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\khalid1\Desktop\pfe-demo - Copy (2)\resources\views/welcome.blade.php ENDPATH**/ ?>