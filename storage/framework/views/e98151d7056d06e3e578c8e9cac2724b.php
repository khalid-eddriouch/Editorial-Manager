...
<?php $__env->startSection('review-commande'); ?>
<div>
  ...
  <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      ...
      <td>
        ...
        <form action="<?php echo e(route('reviewer.creation-review')); ?>"  method="get" >         
          <?php echo csrf_field(); ?>         
          <input type="hidden" value="<?php echo e($article->id); ?>" name="id">
          <input type="hidden " value="<?php echo e(auth::guard('reviewer')->user()->email); ?>" name="e">
...
<?php echo $__env->make('dashboard.reviewer.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\khalid1\Desktop\pfe-demo - Copy (2)\resources\views/dashboard/reviewer/article/review_commande.blade.php ENDPATH**/ ?>