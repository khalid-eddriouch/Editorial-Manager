		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">					
					<li><a href="<?php echo e(route('author.create-article')); ?>">All Authors</a></li>
					<li><a href="<?php echo e(route('author.libre-article')); ?>">All Editors</a></li>
					<li><a href="<?php echo e(route('author.traitement-article')); ?>">All Reviewers</a></li>
				</ul>
			</li>
...
</header><?php /**PATH C:\Users\khalid1\Desktop\pfe-demo - Copy (2)\resources\views/layouts/header.blade.php ENDPATH**/ ?>