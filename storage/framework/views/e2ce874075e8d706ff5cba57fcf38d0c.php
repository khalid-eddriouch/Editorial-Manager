...
<?php $__env->startSection('show_review'); ?>
<div>
<table class="table table-striped">
  ...
  <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      ...
      <td><?php echo e($article->review1); ?></td>
      <td><?php echo e($article->reviewer2Id); ?></td>
      <td><?php echo e($article->review2); ?></td>
      <td>
        <div>
        <!--<li><a href="<?php echo e(route('editor.validation-article')); ?>" >edit</a></li>!-->

        <form action="<?php echo e(route('editor.validation-article')); ?>"  method="get" enctype="multipart/form-data" >         
          <?php echo csrf_field(); ?>         
...
<?php echo $__env->make('dashboard.editor.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\khalid1\Desktop\pfe-demo - Copy (2)\resources\views/dashboard/editor/article/show_review.blade.php ENDPATH**/ ?>